...
class Ground(pygame.sprite.Sprite):
    ...
    def choose_image(self, x, y):
        if self.game.map[y - FIELD[Y]][x - FIELD[X]] == 'G' or \
                self.game.map[y - FIELD[Y]][x - FIELD[X]] == 'S' or \
                self.game.map[y - FIELD[Y]][x - FIELD[X]] == 'I':
            return self.game.ground_spritesheet.get_sprite(0, 96, self.width, self.height)

        list_str = list(self.game.map[y - FIELD[Y]])
        list_str[x - FIELD[X]] = 'R'
        self.game.map[y - FIELD[Y]] = ''.join(list_str)
        if self.game.map[y - FIELD[Y]][x - FIELD[X] - 1] == 'w' and \
                self.game.map[y - FIELD[Y] - 1][x - FIELD[X] - 1] == 'w' and \
                self.game.map[y - FIELD[Y] - 1][x - FIELD[X]] == 'w':
            return self.game.ground_spritesheet.get_sprite(96, 0, self.width, self.height)

        if self.game.map[y - FIELD[Y] - 1][x - FIELD[X]] == 'w' and \
                self.game.map[y - FIELD[Y] - 1][x - FIELD[X] + 1] == 'w' and \
                self.game.map[y - FIELD[Y]][x - FIELD[X] + 1] == 'w':
        ...
        if self.game.map[y - FIELD[Y] + 1][x - FIELD[X] + 1] == 'w' and \
                not self.game.map[y - FIELD[Y] + 1][x - FIELD[X]] == 'w' and \
                not self.game.map[y - FIELD[Y]][x - FIELD[X] + 1] == 'w':
            return self.game.ground_spritesheet.get_sprite(0, 0, self.width, self.height)
        if self.game.map[y - FIELD[Y] + 1][x - FIELD[X]] == 'w':
        ...
        if self.game.map[y - FIELD[Y]][x - FIELD[X] + 1] == 'w':
